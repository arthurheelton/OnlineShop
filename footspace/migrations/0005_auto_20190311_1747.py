# -*- coding: utf-8 -*-
# Generated by Django 1.11.1 on 2019-03-11 14:47
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('footspace', '0004_auto_20190220_1633'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='cart',
            name='items',
            field=models.ManyToManyField(blank=True, to='footspace.CartItem'),
        ),
        migrations.AddField(
            model_name='order',
            name='items',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='footspace.Cart'),
        ),
        migrations.AddField(
            model_name='order',
            name='user',
